...
public class StarHelper {
    ...
    public StarHelper(Context root, Fragment f) {
        this.mContext = root;
        this.mFragment = f;
    }
    ...
    public void help() {
        ...
        View contentView = mFragment.getLayoutInflater().inflate(R.layout.dialog_star,
                null);
        mStarSpinner = contentView.findViewById(R.id.star_spinner);
        mDataSpinner = contentView.findViewById(R.id.data_spinner);
        mRecycleView = contentView.findViewById(R.id.result_rcl_star);
    ...
    private String getReqBody() {
        ...
        String consName = mStarSpinner.getSelectedItem().toString();
        String type = mDataSpinner.getSelectedItem().toString();
        try {
            sb.append("consName=")
